...
@Component({
  ...
  template: `
    ...
    -->
    <nav class="mx-4 mb-1 flex flex-row items-center p-1 lg-pill !rounded-[25px] bg-white/[0.03] backdrop-blur-3xl border border-white/[0.1] shadow-[0_20px_50px_rgba(0,0,0,0.4)] relative overflow-hidden"
